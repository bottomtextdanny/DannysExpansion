...
public class HollowArmorModel extends BCEntityModel<HollowArmor> {
    ...
    public HollowArmorModel() {
        ...
        this.hip.setPosCore(0.0F, -15.0F, 0.0F);
        this.model.addChild(this.hip);
        this.hip.uvOffset(0, 0).addBox(-4.0F, -4.0F, -2.0F, 8.0F, 4.0F, 4.0F, 0.25F, false);

        this.abdomen = new BCJoint(this);
        this.abdomen.setPosCore(0.0F, -3.0F, 0.0F);
        this.hip.addChild(this.abdomen);
        this.abdomen.uvOffset(0, 8).addBox(-4.0F, -5.0F, -2.0F, 8.0F, 4.0F, 4.0F, 0.0F, false);

        this.chest = new BCJoint(this);
        this.chest.setPosCore(0.0F, -5.0F, 0.0F);
        this.abdomen.addChild(this.chest);
        setRotationAngle(this.chest, 0.0873F, 0.0F, 0.0F);
        this.chest.uvOffset(24, 0).addBox(-5.0F, -6.0F, -3.0F, 10.0F, 6.0F, 6.0F, 0.0F, false);

        this.rightArm = new BCJoint(this);
        this.rightArm.setPosCore(-5.0F, -4.0F, 0.0F);
        this.chest.addChild(this.rightArm);
        setRotationAngle(this.rightArm, 0.0873F, -0.0873F, 0.0873F);
        this.rightArm.uvOffset(12, 16).addBox(-3.0F, -1.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.1F, false);

        this.rightForearm = new BCJoint(this);
        this.rightForearm.setPosCore(-1.5F, 5.0F, 0.0F);
        this.rightArm.addChild(this.rightForearm);
        setRotationAngle(this.rightForearm, -0.3491F, 0.0F, 0.0F);
        this.rightForearm.uvOffset(0, 16).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, 0.0F, false);

        this.rightHand = new BCJoint(this);
        this.rightHand.setPosCore(0.0F, 4.0F, 0.0F);
        this.rightForearm.addChild(this.rightHand);
        this.rightHand.uvOffset(0, 23).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);

        this.sword = new BCJoint(this);
        this.sword.setPosCore(0.0F, 2.0F, 0.5F);
        this.rightHand.addChild(this.sword);
        this.sword.uvOffset(24, 12).addBox(-1.0F, -1.0F, -3.5F, 2.0F, 2.0F, 6.0F, 0.0F, false);
        this.sword.uvOffset(14, 40).addBox(-1.5F, -1.5F, 2.5F, 3.0F, 3.0F, 2.0F, 0.0F, false);
        this.sword.uvOffset(34, 12).addBox(-1.5F, -1.5F, -4.5F, 3.0F, 3.0F, 1.0F, 0.0F, false);

        this.rightShoulderPad = new BCJoint(this);
        this.rightShoulderPad.setPosCore(0.0F, 0.0F, 0.0F);
        this.rightArm.addChild(this.rightShoulderPad);
        setRotationAngle(this.rightShoulderPad, 0.0F, 0.0F, 0.0436F);
        this.rightShoulderPad.uvOffset(19, 20).addBox(-4.5F, -3.0F, -2.5F, 5.0F, 5.0F, 5.0F, 0.0F, false);

        this.leftArm = new BCJoint(this);
        this.leftArm.setPosCore(5.0F, -4.0F, 0.0F);
        this.chest.addChild(this.leftArm);
        setRotationAngle(this.leftArm, 0.0873F, 0.0873F, -0.0873F);
        this.leftArm.uvOffset(12, 16).addBox(0.0F, -1.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.1F, true);

        this.leftForearm = new BCJoint(this);
        this.leftForearm.setPosCore(1.5F, 5.0F, 0.0F);
        this.leftArm.addChild(this.leftForearm);
        setRotationAngle(this.leftForearm, -0.3491F, 0.0F, 0.0F);
        this.leftForearm.uvOffset(0, 16).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, 0.0F, true);

        this.leftHand = new BCJoint(this);
        this.leftHand.setPosCore(0.0F, 4.0F, 0.0F);
        this.leftForearm.addChild(this.leftHand);
        this.leftHand.uvOffset(0, 23).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, true);

        this.head = new BCJoint(this);
        this.head.setPosCore(0.0F, -6.0F, 0.0F);
        this.chest.addChild(this.head);
        this.head.uvOffset(39, 12).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
        this.head.uvOffset(28, 30).addBox(-1.0F, -10.0F, -2.0F, 2.0F, 8.0F, 8.0F, 0.0F, false);
        this.head.uvOffset(48, 28).addBox(-1.0F, -12.0F, -3.0F, 2.0F, 14.0F, 12.0F, 0.0F, false);

        this.rightLeg = new BCJoint(this);
        this.rightLeg.setPosCore(-2.5F, -15.0F, 0.0F);
        this.model.addChild(this.rightLeg);
        setRotationAngle(this.rightLeg, -0.0873F, 0.0873F, 0.0873F);
        this.rightLeg.uvOffset(0, 31).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, 0.0F, false);

        this.rightLegLower = new BCJoint(this);
        this.rightLegLower.setPosCore(0.0F, 7.0F, 0.0F);
        this.rightLeg.addChild(this.rightLegLower);
        setRotationAngle(this.rightLegLower, 0.1745F, -0.0873F, 0.0F);
        this.rightLegLower.uvOffset(16, 30).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 7.0F, 3.0F, 0.1F, false);

        this.rightFoot = new BCJoint(this);
        this.rightFoot.setPosCore(0.0F, 7.0F, 0.0F);
        this.rightLegLower.addChild(this.rightFoot);
        setRotationAngle(this.rightFoot, -0.0873F, 0.0F, -0.0873F);
        this.rightFoot.uvOffset(0, 42).addBox(-2.0F, -1.0F, -4.0F, 4.0F, 2.0F, 6.0F, 0.0F, false);

        this.leftLeg = new BCJoint(this);
        this.leftLeg.setPosCore(2.5F, -15.0F, 0.0F);
        this.model.addChild(this.leftLeg);
        setRotationAngle(this.leftLeg, -0.0873F, -0.0873F, -0.0873F);
        this.leftLeg.uvOffset(0, 31).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, 0.0F, true);

        this.leftLegLower = new BCJoint(this);
        this.leftLegLower.setPosCore(0.0F, 7.0F, 0.0F);
        this.leftLeg.addChild(this.leftLegLower);
        setRotationAngle(this.leftLegLower, 0.1745F, 0.0873F, 0.0F);
        this.leftLegLower.uvOffset(16, 30).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 7.0F, 3.0F, 0.1F, true);

        this.leftFoot = new BCJoint(this);
        this.leftFoot.setPosCore(0.0F, 7.0F, 0.0F);
        this.leftLegLower.addChild(this.leftFoot);
        setRotationAngle(this.leftFoot, -0.0873F, 0.0F, 0.0873F);
        this.leftFoot.uvOffset(0, 42).addBox(-2.0F, -1.0F, -4.0F, 4.0F, 2.0F, 6.0F, 0.0F, true);
        //modelInitEnd
    }
    ...
    public void handleKeyframedAnimations(HollowArmor entity, float limbSwing, float limbSwingAmount, float headYaw, float headPitch) {
        ModelAnimator animator = new ModelAnimator(this, (float) entity.mainHandler.getTick() + getPartialTick());
        float walkMult = 1.0F;
        ...
        if(entity.mainHandler.isPlaying(HollowArmor.BLUNT)) {
        ...
        else if(entity.mainHandler.isPlaying(HollowArmor.SWING)) {
            ...
            ModelAnimator deathAnimator = new ModelAnimator(this, (float) entity.getLocalAnimationHandler().getTick() + getPartialTick());
            ...
            ModelAnimator animator1 = new ModelAnimator(this, (float) entity.mainHandler.getTick() + getPartialTick());
            ModelAnimator posFixer = new ModelAnimator(this, (float) entity.mainHandler.getTick() + getPartialTick());
        ...
        ModelAnimator walk = new ModelAnimator(this, Mth.clamp(easedLimbSwing, (float) 0, 0.999F)).multiplier(f);
