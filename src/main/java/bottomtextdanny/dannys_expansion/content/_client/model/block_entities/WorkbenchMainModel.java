...
public class WorkbenchMainModel extends BCBlockEntityModel<WorkbenchBlockEntity> {
    ...
    public WorkbenchMainModel() {
        ...
        root.uvOffset(0, 19).addBox(-6.0F, -5.0F, 3.0F, 4.0F, 5.0F, 4.0F, 0.0F, false);
        root.uvOffset(0, 0).addBox(-6.0F, -5.0F, -7.0F, 4.0F, 5.0F, 4.0F, 0.0F, false);
        root.uvOffset(0, 56).addBox(-6.0F, -9.0F, -7.0F, 14.0F, 4.0F, 14.0F, 0.0F, false);
        root.uvOffset(0, 19).addBox(-8.0F, -12.0F, -8.0F, 16.0F, 3.0F, 16.0F, 0.0F, false);
    }
