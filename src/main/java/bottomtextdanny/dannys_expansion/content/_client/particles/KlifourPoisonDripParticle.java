...
public class KlifourPoisonDripParticle extends DannyParticle {

    protected KlifourPoisonDripParticle(ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet handleSpriteSet) {
