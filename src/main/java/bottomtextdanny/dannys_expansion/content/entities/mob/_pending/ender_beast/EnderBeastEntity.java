...
public abstract class EnderBeastEntity extends ModuledMob implements Enemy {
	...
	public static final AnimationArray BASE_ANIMATIONS = new AnimationArray(SLIGHT_TALK, SMALL_TALK, TALK, SCREAM);
    ...
    public final IntScheduler hurtColorTimer;
    ...
    public EnderBeastEntity(EntityType<? extends PathfinderMob> type, Level worldIn) {
        ...
        this.hurtColorTimer = IntScheduler.simple(15);
    ...
    public void tick() {
	    if (this.level.isClientSide()) {
            ...
            this.hurtColorTimer.incrementFreely(1);
