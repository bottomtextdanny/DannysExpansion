...
public abstract class BasicSummonEntity extends ModuledMob implements SummonEntity {
    ...
    public static final EntityDataReference<IntScheduler.Simple> USELESS_TIMER_REF =
            BCDataManager.attribute(BasicSummonEntity.class,
    ...
    public BasicSummonEntity(EntityType<? extends PathfinderMob> type, Level worldIn) {
        super(type, worldIn);
