...
public enum DannyItemTier implements Tier {
	ECLIPSE(4, 3781, 9.0F, 5.5F, 12, () -> {
		return Ingredient.of(DEBuildingItems.FOAMSHROOM.get());
	}),
    ...
    DannyItemTier(int harvestLevelIn, int maxUsesIn, float efficiencyIn, float attackDamageIn, int enchantabilityIn, Supplier<Ingredient> repairMaterialIn) {
