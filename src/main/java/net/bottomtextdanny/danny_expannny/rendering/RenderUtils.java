...
public final class RenderUtils {
    ...
    public static void renderItemModelIntoGUI(PoseStack matrixStack, ItemStack stack, int x, int y, int brightness) {
        ...
        posestack.pushPose();
        posestack.translate((double)x, (double)y, (double)Minecraft.getInstance().getItemRenderer().blitOffset);
        ...
        Minecraft.getInstance().getItemRenderer().render(stack, ItemTransforms.TransformType.GUI, false, matrixStack, multibuffersource$buffersource, brightness, OverlayTexture.NO_OVERLAY, model);
