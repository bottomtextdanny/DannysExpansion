...
public class DannyButton extends AbstractButton {
    ...
    public DannyButton(int x, int y, int width, int height, Component title, IClickResponse clickConsumer, IInit init) {
    ...
    public DannyButton(int width, int height, Component title, IClickResponse clickConsumer, IInit init) {
    ...
    public DannyButton(int x, int y, int width, int height, Component title, IClickResponse clickConsumer) {
        super(x, y, width, height, title);
        this.originalX = x;
        this.originalY = y;
        this.clickConsumer = clickConsumer;
    ...
    public DannyButton(int width, int height, Component title, IClickResponse clickConsumer) {
        super(0, 0, width, height, title);
        this.originalX = 0;
        this.originalY = 0;
        this.clickConsumer = clickConsumer;
