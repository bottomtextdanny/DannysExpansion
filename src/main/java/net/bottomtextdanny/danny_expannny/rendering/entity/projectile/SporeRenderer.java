...
public class SporeRenderer extends EntityRenderer<SporeEntity> {
    ...
    public SporeRenderer(Object manager) {
        this((EntityRendererProvider.Context) manager);
    }

    public SporeRenderer(EntityRendererProvider.Context renderManagerIn) {
    ...
    @Override
    protected int getBlockLightLevel(SporeEntity entityIn, BlockPos partialTicks) {
        return 15;
    }
}
