...
public class SWSpectralBoltRenderer extends DannyArrowRenderer<AbstractArrow> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(DannysExpansion.ID, "textures/entity/arrow/nothing.png");
    private static final ResourceLocation FULLBRIGHT_TEXTURES = new ResourceLocation(DannysExpansion.ID, "textures/entity/arrow/sw/bolt_spectral_fullbright.png");

    public SWSpectralBoltRenderer(EntityRendererProvider.Context renderManagerIn) {
