...
import net.bottomtextdanny.dannys_expansion.core.interfaces.item.IBigBowModelLoader;
...
public class EquinoxItem extends DannyBowItem implements IBigBowModelLoader {
    ...
    public void shoot(Level world, Player player, ItemStack stack, float progress) {
        ...
        if (player.isEffectiveAi()) player.playSound(DESounds.IS_LIGHT_BOW_SHOT.get(), 1.0F, 0.8F + this.random.nextFloat() * 0.2F);
