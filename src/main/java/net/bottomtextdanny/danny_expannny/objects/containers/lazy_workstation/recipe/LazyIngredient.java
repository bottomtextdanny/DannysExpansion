...
public interface LazyIngredient {
	...
	//@OnlyIn(Dist.CLIENT)
	//	default List<Component> tooltip(ItemStack screenItemStack, Inventory inventory, TooltipFlag flag) {
	//		return screenItemStack.getTooltipLines(inventory.player, flag);
	//	}
	int getCount();
	...
	LazyIngredient deserialize(CompoundTag compound);
