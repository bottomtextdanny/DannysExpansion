...
public class ExplosionParticle extends TextureSheetParticle {
    ...
    private ExplosionParticle(ClientLevel p_i232396_1_, double p_i232396_2_, double p_i232396_4_, double p_i232396_6_, double xSpeed, double ySpeed, double zSpeed, SpriteSet p_i232396_10_) {
        ...
        this.gCol = f;
        this.bCol = f;
        this.quadSize = this.random.nextFloat() * 0.1F + 0.7F;
