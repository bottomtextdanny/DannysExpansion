...
public class GhoulSwampModel extends BaseGhoulModel {

    public GhoulSwampModel() {
        this.texWidth = 64;
        this.texHeight = 64;
	    ...
	    setRotationAngle(this.hip, -0.2182F, 0.0F, 0.0F);
	    ...
	    setRotationAngle(this.chest, 0.1746F, 0.0F, 0.0F);
        this.chest.texOffs(0, 10).addBox(-6.0F, -7.0F, -2.5F, 12.0F, 7.0F, 6.0F, 0.0F, false);
        this.chest.texOffs(28, 23).addBox(-6.0F, -7.0F, -2.5F, 12.0F, 7.0F, 6.0F, 0.5F, false);
        ...
        this.rightArm.texOffs(46, 0).addBox(-3.0F, -1.0F, -1.5F, 3.0F, 7.0F, 3.0F, 0.5F, false);
        ...
        this.leftArm.texOffs(46, 0).addBox(0.0F, -1.0F, -1.5F, 3.0F, 7.0F, 3.0F, 0.5F, true);
        ...
        this.head.texOffs(0, 48).addBox(-4.0F, -8.0F, -6.0F, 8.0F, 8.0F, 8.0F, 0.5F, false);
