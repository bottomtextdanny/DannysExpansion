...
import net.bottomtextdanny.de_json_generator.jsonBakers._blockstate.*;
...
import net.bottomtextdanny.de_json_generator.jsonBakers._recipehelper.RecipeShapedMaster;
import net.bottomtextdanny.de_json_generator.jsonBakers._recipehelper.RecipeShapelessMaster;
import net.bottomtextdanny.de_json_generator.jsonBakers._recipehelper.RecipeSmeltingMaster;
import net.bottomtextdanny.de_json_generator.jsonBakers._wb_recipe.WBObjectBaker;
import net.bottomtextdanny.de_json_generator.jsonBakers._wb_recipe.WBRecipeBaker;
import net.bottomtextdanny.de_json_generator.jsonBakers.itemmodel.FreeItemModel;
import net.bottomtextdanny.de_json_generator.jsonBakers.itemmodel.ItemModel;
import net.bottomtextdanny.de_json_generator.jsonBakers.itemmodel.SimpleItemModel;
import net.bottomtextdanny.de_json_generator.jsonBakers.loottablegenerator.*;
import net.bottomtextdanny.de_json_generator.jsonBakers.loottablegenerator.functions.ApplyBonusFunction;
...
import net.bottomtextdanny.de_json_generator.types.extension.LootTableGenExt;
import net.bottomtextdanny.de_json_generator.types.extension.RecipeGenExt;
import net.bottomtextdanny.de_json_generator.types.item.ItemGenerator;
import net.bottomtextdanny.de_json_generator.types.item.MatrixTemplateModel;
...
public class GenUtils extends JsonUtilsFrontend {
	...
	public static WBObjectBaker wbi_item(String itemID, int count) {
		return new WBObjectBaker("item", itemID, count);
	}
	
	public static WBObjectBaker wbi_tag(String tagID, int count) {
		return new WBObjectBaker("tag", tagID, count);
	}
